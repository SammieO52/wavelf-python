...
r=int(input("What habitat # do you need?"))
...
#Since I only sent a practice question last week I thought I would send you part of my project from last week. Sorry!
